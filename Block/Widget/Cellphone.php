...
{   
    ...
    {
        return $this->_getAttribute('telephone') ? (bool)$this->_getAttribute('telephone')->isVisible() : false;
    }
    ...
    {
        return $this->_getAttribute('telephone') ? (bool)$this->_getAttribute('telephone')->isRequired() : false;
    }
}
