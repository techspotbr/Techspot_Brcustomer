...
class Document extends \Magento\Customer\Block\Widget\AbstractWidget
{
    ...
    {
        parent::_construct();
        $this->setTemplate('widget/document.phtml');
    }
    ...
    {
        return $this->_getAttribute('document') ? (bool)$this->_getAttribute('document')->isVisible() : false;
    }
    ...
    {
        return $this->_getAttribute('document') ? (bool)$this->_getAttribute('document')->isRequired() : false;
    }
}
