...
class Stateinscription extends \Magento\Customer\Block\Widget\AbstractWidget
{
    ...
    {
        parent::_construct();
        $this->setTemplate('widget/stateinscription.phtml');
    }
    ...
    {
        return $this->_getAttribute('state_inscription') ? (bool)$this->_getAttribute('state_inscription')->isVisible() : false;
    }
    ...
    {
        return $this->_getAttribute('state_inscription') ? (bool)$this->_getAttribute('state_inscription')->isRequired() : false;
    }
}
