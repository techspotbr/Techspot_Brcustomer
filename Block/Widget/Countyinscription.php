...
{   
    ...
    {
        parent::_construct();
        $this->setTemplate('widget/countyinscription.phtml');
    }
    ...
    {
        return $this->_getAttribute('county_inscription') ? (bool)$this->_getAttribute('county_inscription')->isVisible() : false;
    }
    ...
    {
        return $this->_getAttribute('county_inscription') ? (bool)$this->_getAttribute('county_inscription')->isRequired() : false;
    }
}
